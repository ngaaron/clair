...
function options_admin_menu(){
    add_menu_page( 'Clair', 'Clair', 'administrator', 'base-settings', 'BaseSettings', '', 100);
    add_submenu_page('base-settings', '主题设置', '主题设置', 'administrator', 'base-settings', 'BaseSettings');
    add_submenu_page('base-settings', '主题说明', '主题说明', 'administrator', 'advanced-settings', 'AdvancedSettings');
}
