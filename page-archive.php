        ...
        <div class="full-content" >
            ...
            <div class="archive-review">
                ...
                <div class="archive-grid">
                    ...
                    <span><?php $count_pages = wp_count_posts('page'); echo $page_posts = $count_pages->publish; ?>个页面</span>
                     <p class="block-postMeta"></p>
                </div> 
                <div class="archive-grid">
                    <div class="iconxxx">
                ...
                <div class="archive-grid">
                    ...
                    <span><?php $count_posts = wp_count_posts(); echo $published_posts = $count_posts->publish; ?>篇文章</span>
                     <p class="block-postMeta"></p>
                </div>
                <div class="archive-grid">
                    <div class="iconxxx">
                    ...
                    <span><?php $total_comments = get_comment_count(); echo $total_comments['approved'];?>评论</span>
                     <p class="block-postMeta"></p>
                </div>
            </div>
